<h1>allday Shop</h1>
allday shop is a mini REST API e-commerce project that made by Golang
...
```bash
docker exec -it allday_db_test bash
psql -U allday
CREATE DATABASE allday_db_test;
\l
```
...
```bash
# Migrate up
migrate -database 'postgres://allday:123456@0.0.0.0:4444/allday_db_test?sslmode=disable' -source file://D:/path-to-migrate -verbose up

# Migrate down
migrate -database 'postgres://allday:123456@0.0.0.0:4444/allday_db_test?sslmode=disable' -source file://D:/path-to-migrate -verbose down
```
